...
public class ICICIBank {
	...
	private Account searchAmount(int accountNo,int ammount)throws InsufficientBalanceException
	{
		for(Account account : accounts)
		{
	...
	public int withdrawAccount(int accountNumber,int amount) throws InvalidAccountNumberException,InsufficientBalanceException
	{
	{
		Account account = searchAccount(accountNumber);
	...
	public void transferAmmount(int account1, int account2, int ammount)throws InvalidAccountNumberException,InsufficientBalanceException
	{
